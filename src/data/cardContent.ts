...
export const cards: Card[] = [
  ...
  },
  {
    ...
    customStyle: {
      cssVariables: {
        ...
        '--card-bg': '#faf5e8',
        '--box-shadow': '0 1px 0 rgba(255,255,255,0.9) inset, 0 -1px 0 rgba(26,20,16,0.04) inset, 0 1px 2px rgba(26,20,16,0.04), 0 8px 22px -10px rgba(26,20,16,0.18), 0 22px 50px -28px rgba(26,20,16,0.22)',
        '--card-border': '1px solid rgba(26, 20, 16, 0.10)',
        '--backdrop-filter': 'blur(10px)',
      },
    },
  },
  {
    ...
    position: { span: 2 },
    customStyle: {
      cssClasses: ['on-the-shelf-card'],
      cssVariables: {
        '--text-primary': '#1a1410',
        '--text-secondary': '#4a3f31',
        '--text-tertiary': '#8b7e6a',
        '--text-color': '#1a1410',
        '--card-bg': 'linear-gradient(180deg, #f3e8cf 0%, #ead9b3 100%)',
        '--box-shadow': '0 1px 0 rgba(255,255,255,0.9) inset, 0 -1px 0 rgba(26,20,16,0.04) inset, 0 1px 2px rgba(26,20,16,0.04), 0 8px 22px -10px rgba(26,20,16,0.18), 0 22px 50px -28px rgba(26,20,16,0.22)',
        '--card-border': '1px solid rgba(120, 80, 30, 0.25)',
        '--backdrop-filter': 'blur(10px)',
      },
    },
  },
  {
    ...
    position: { span: 3 },
    customStyle: {
      cssClasses: ['journey-card'],
      cssVariables: {
        '--text-primary': '#1a1410',
        '--text-secondary': '#4a3f31',
        '--text-tertiary': '#8b7e6a',
        '--text-color': '#1a1410',
        '--card-bg': 'radial-gradient(80% 100% at 50% 0%, rgba(232, 89, 12, 0.04), transparent 60%), #faf5e8',
        '--card-bg-fill': '#faf5e8',
        '--detail-bg': 'rgba(250, 245, 232, 0.96)',
        '--box-shadow': '0 1px 0 rgba(255,255,255,0.9) inset, 0 -1px 0 rgba(26,20,16,0.04) inset, 0 1px 2px rgba(26,20,16,0.04), 0 8px 22px -10px rgba(26,20,16,0.18), 0 22px 50px -28px rgba(26,20,16,0.22)',
        '--card-border': '1px solid rgba(26, 20, 16, 0.10)',
        '--backdrop-filter': 'blur(10px)',
      },
